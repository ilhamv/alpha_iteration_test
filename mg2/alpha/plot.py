...
ln1b = ax1.plot(delta_list_mc,alpha_mc,'bo',fillstyle='none',label=r'$\alpha$ - OpenMC')
...
ln2b = ax2.plot(delta_list_mc,rat12_mc,'rD', fillstyle='none',label=r'$\phi_2/\phi_1$ - OpenMC')
